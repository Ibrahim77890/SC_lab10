...
public class ExpressionParser extends Parser {
  ...
  private static Expression parseExpression(String input) {
      ...
      while (i < input.length()) {
          ...
          if (Character.isDigit(ch)) {
              ...
              operands.push(new expressivo.Number(number));
              continue;
              ...
              String variable = input.substring(start, i);
              operands.push(new Variable(variable));
              continue;
          } else if (ch == '(') {
              operators.push(ch);
          } else if (ch == ')') {
  ...
  private static void applyOperator(Stack<Character> operators, Stack<Expression> operands) {
      ...
      switch (operator) {
          case '+':
              operands.push(new Addition(left, right));
              break;
          case '*':
              operands.push(new Multiplication(left, right));
              break;
          default:
